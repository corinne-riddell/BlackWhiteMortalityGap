---
title: "Run models - local version"
...
source("/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/Code/2_smoothing_models/bayes_smoothing_functions.R")
source("/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/Code/life_expectancy_functions.R")
```

```{r load_tidied_data}
dat.clean = read.csv('/Users/corinneriddell/Dropbox/BlackWhiteGap/Data/dat_clean.csv') 
```

```{r fit_models_alabama_males}
...
r.White <- rbind(r.Black.Florida.Male, r.Black.Georgia.Male, r.Black.Illinois.Male, r.Black.Indiana.Male,
                 r.Black.Florida.Female, r.Black.Georgia.Female, r.Black.Illinois.Female, r.Black.Indiana.Female)
r.Black$race <- "Black"
```
...
save(r.All, le.calculations, file = "/Users/corinneriddell/Documents/BW_results/results_set_3.Rdata") 
write.csv(x = BlackWhite, file = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/Results/BlackWhite_set_3.csv")
write.csv(x = age.decomp.estimates, file = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/Results/age_decomp_set_3.csv")
write.csv(x = cod.marginal.estimates, file = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/Results/cod_marginal_set_3.csv")
write.csv(x = age.cod.estimates, file = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/Results/age_cod_set_3.csv")
```
