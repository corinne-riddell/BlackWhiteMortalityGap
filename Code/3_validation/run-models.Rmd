...
list_set2 <- list("Colorado", "Connecticut", "Delaware", "Washington DC", "Florida", "Georgia") #saved as results_set_2
...
r.White <- rbind(r.Black.Colorado.Male, r.Black.Connecticut.Male, r.Black.Delaware.Male, r.Black.WashingtonDC.Male,
                 r.Black.Colorado.Female, r.Black.Connecticut.Female, r.Black.Delaware.Female, r.Black.WashingtonDC.Female)
r.Black$race <- "Black"
```
