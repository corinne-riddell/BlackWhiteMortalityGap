...
r.White <- run_analysis(dataset = dat.clean, state1 = "Alabama", sex1 = "Male", race1 = "White")
r.White$race <- "White"

r.Black <- run_analysis(dataset = dat.clean, state1 = "Alabama", sex1 = "Male", race1 = "Black")
r.Black$race <- "Black"
```
