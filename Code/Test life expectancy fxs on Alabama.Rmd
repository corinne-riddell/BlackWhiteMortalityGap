...
```{r}
life.table.whites <- data.frame(life.table(data = first.strata, age.groups = "Age2", num.ages.in.group = "nx", death.counts = "total_deaths5", population.counts = "Population"))
...
ggplot(life.table.blacks, aes(x = Age3, y = q_x, col = "q_x: Probability")) + geom_point() + geom_point(aes(y = R_x, col="R_x: Mortality rate")) + scale_y_continuous(name = "Value") + scale_x_continuous(name = "Age") + ggtitle("Examining the relationship between the probability of dying and the mortality rate")
