...
dat$RID <- paste(dat$stabbrs, dat$year, substr(dat$sex, 1, 1),
                 substr(dat$race, 1, 1), dat$age.n, dat$COD, sep = ".")
```
...
for(i in 1:length(included.states)) { 
  ...
  write.csv(ds_temp, file = paste0("/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/Data/", name))
}
rm(ds_temp)
```
