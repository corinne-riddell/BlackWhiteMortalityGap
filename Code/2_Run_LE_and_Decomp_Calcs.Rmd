...
dat.clean<- read.csv("/Users/corinneriddell/Dropbox/BlackWhiteGap/Data/dat_clean.Rdata", header = T)
```
...
system.time(
  for(i in 1:dim(paired.ids)[1]) {
    ...
    list.cod.decomp.tables1[[i]]$StateYearSex <- paired.ids[i, "StateYearSex"]
    list.cod.decomp.tables5[[i]]$StateYearSex <- paired.ids[i, "StateYearSex"]
    list.cod.decomp.tables9[[i]]$StateYearSex <- paired.ids[i, "StateYearSex"]
