...
```{r load_data}
dat.aggregated <- read.csv("/Users/corinneriddell/Dropbox/BlackWhiteGap/Data/dat_aggregated.Rdata", header = T)
dat.clean<- read.csv("/Users/corinneriddell/Dropbox/BlackWhiteGap/Data/dat_aggregated.Rdata", header = T)
```
...
dat.clean$StateYearSex <- interaction(dat.clean$State_factor, dat.clean$Year_factor, dat.clean$Sex_factor)
