...
life.table.cm <- life.table(data = canada.men, age.groups = "ages", num.ages.in.group = "n_x", 
                            death.counts = "obs.deaths", population.counts = "obs.popn")

round(life.table.cm, 2)

life.table.qm <- life.table(data = quebec.men, age.groups = "ages", num.ages.in.group = "n_x", 
                            death.counts = "obs.deaths", population.counts = "obs.popn")
...
canada.cod.decomp <- cause_of_death_decomp(life.table1 = life.table.qm, life.table2 = life.table.cm, decomp.table = age_decomp,
                      ...
                      prop1.colname.cod.table = "prop.QC", prop2.colname.cod.table = "prop.CAD")
```
