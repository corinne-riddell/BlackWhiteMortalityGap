...
grid.arrange(img3,
             ...
             ncol = 3)
```
Jay Kaufman, Supervisor        Kathryn Morrison, Post-doc       Sam Harper, Professor
...
+ Estimate smoothed mortality rates and impute coarsened data using a Bayesian time series model 
+ 1,000 posterior samples containing estimated *smoothed* and *imputed* death counts
+ For each sample:
