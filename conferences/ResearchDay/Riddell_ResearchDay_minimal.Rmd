...
```{r, echo=F}
img1 <-  rasterGrob(as.raster(readPNG("/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/conferences/ResearchDay/images/k_morrison.png")), interpolate = FALSE)
img2 <-  rasterGrob(as.raster(readPNG("/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/conferences/ResearchDay/images/s_harper2.png")), interpolate = FALSE)
img3 <-  rasterGrob(as.raster(readJPEG("/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/conferences/ResearchDay/images/j_kaufman.jpg")), interpolate = FALSE)
grid.arrange(img3,
             img1,
             img2,
             ncol = 3)
...
include_graphics(path = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/conferences/ResearchDay/images/Harper_HA_title.png")
```

```{r, echo=F, out.width = 750}
include_graphics(path = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/conferences/ResearchDay/images/Harper_HA_fig1.png")
```

----

```{r, echo = F, out.width = 250}
include_graphics(path = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/conferences/ResearchDay/images/Harper_HA_quote.png")
```

## The data

```{r, echo = F, out.width = 400}
include_graphics(path = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/conferences/ResearchDay/images/alabama.data.ex.png")
```
...
+ R Shiny App: https://corinne-riddell.shinyapps.io/shiny_app/

## The app

```{r, echo = F, out.width = 800}
include_graphics(path = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/conferences/ResearchDay/images/app_ex1.gif")
```

## The app

```{r, echo = F, out.width = 800}
include_graphics(path = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/conferences/ResearchDay/images/app_ex2.gif")
```

## The app

```{r, echo = F, out.width = 800}
include_graphics(path = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/conferences/ResearchDay/images/app_ex3.gif")
```
...
include_graphics(path = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/conferences/ResearchDay/images/CVD_men.png")
```

##Cancer in women
```{r, echo = F, out.width = 675}
include_graphics(path = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/conferences/ResearchDay/images/Cancer_women.png")
```

##Injury in women
```{r, echo = F, out.width = 675}
include_graphics(path = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/conferences/ResearchDay/images/Injury_women.png")
```
