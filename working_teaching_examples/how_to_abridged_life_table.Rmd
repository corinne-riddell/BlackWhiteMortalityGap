...
We can then substitute this expression for $l_x$ into the equations for $q_x$:
...
life.table(data = cali.abridged, age.groups = "ages", num.ages.in.group = "nx", 
...
system.time(first.strata.life.table <- life.table(data = first.strata, age.groups = "Age2", num.ages.in.group = "nx", death.counts = "total_deaths5", population.counts = "Population"))

View(first.strata.life.table)
...
le_age_decomp <- function(data1, data2, num.alive, interval.years.lived, accumulated.years.lived) {
  ...
  (data1[num.alive]/data1[1, num.alive])*((data2[interval.years.lived]/data2[num.alive]) - (data1[interval.years.lived]/data1[num.alive])) +
    ((data2[accumulated.years.lived]/data2[1, num.alive])*((data1[num.alive]/data2[num.alive]) - ))
}
