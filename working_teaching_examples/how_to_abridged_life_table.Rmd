...
life.table <- function(data, age.groups, num.ages.in.group, death.counts, population.counts, ave.prop.lived = NA, calendar.years = NA){
...
cali.abridged <- data.frame("ages" = c("0-1y", "1-4y", "5-9y", "10-14y", "15+y"), "nx" = c(1, 4, 5, 5, 5),
                         "obs.deaths" = c(1635, 168, 251, 371, 23300), #last number is fictitious
                         "obs.popn" = c(123342, 435167, 578964, 649693, 143600))
