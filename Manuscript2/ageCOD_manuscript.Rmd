...
men_cod_contributions <- age_cod_results %>% ungroup() %>% filter(sex == "Male", state %in% c("California", "New York", "Illinois", "Georgia"))

women_cod_contributions <- age_cod_results %>% ungroup() %>% filter(sex == "Female", state %in% c("California", "New York", "Illinois", "Georgia"))
```
