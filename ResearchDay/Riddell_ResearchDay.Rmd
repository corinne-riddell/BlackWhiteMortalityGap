...
```{r plot_LE_trends_males, echo=F, fig.height=9, fig.width=11, out.height="90%", out.width = "90%"}
LE_trend_plot_males <- LE_trend_plot_males + 
...
LE_trend_plot_males2 <- refine.patterns(ggplotly(LE_trend_plot_males))

LE_trend_plot_males2
...
include_graphics(path = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/ResearchDay/images/k_morrison.png")
```

```{r, echo=F, out.width="15%", dpi=72, fig.cap="Sam Harper, PhD"}
include_graphics(path = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/ResearchDay/images/s_harper.jpeg")
```

```{r, echo=F, out.width="15%", dpi=72, fig.cap="Jay Kaufman, PhD"}
include_graphics(path = "/Users/corinneriddell/Documents/repos/BlackWhiteMortalityGap/ResearchDay/images/j_kaufman.jpg")
```
