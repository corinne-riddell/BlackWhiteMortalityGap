...
ggplotly(ggplot(subset(cod.contributions, Sex2 == "Male" & Cause.of.death == "Communicable" & C_x_COD_proportion < 0.5 & C_x_COD_proportion > -0.5), aes(x = Year3, y = C_x_COD_proportion)) +
         geom_line(aes(col = State2)) + facet_wrap(~ Census_Region) +
         ylab("Contribution to LE Gap (%)") +
         xlab("Year") +
