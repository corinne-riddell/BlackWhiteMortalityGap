...
ggplotly(Cardiovascular.Male.plot[[3]]) %>% layout(xaxis = list(title = "Year"))
```
...
ggplotly(Cardiovascular.Female.plot[[3]]) %>% layout(xaxis = list(title = "Year"))
```
...
ggplotly(Cancers.Male.plot[[3]]) %>% layout(xaxis = list(title = "Year"))
```
...
ggplotly(Cancers.Female.plot[[3]]) %>% layout(xaxis = list(title = "Year"))
```
...
ggplotly(`Non-communicable.Male.plot`[[3]]) %>% layout(xaxis = list(title = "Year"))
```
...
ggplotly(`Non-communicable.Female.plot`[[3]]) %>% layout(xaxis = list(title = "Year"))
```
...
ggplotly(Injuries.Male.plot[[3]]) %>% layout(xaxis = list(title = "Year"))
```
...
ggplotly(Injuries.Female.plot[[3]]) %>% layout(xaxis = list(title = "Year"))
```
...
ggplotly(Communicable.Male.plot[[3]]) %>% layout(xaxis = list(title = "Year"))
```
...
ggplotly(Communicable.Female.plot[[3]]) %>% layout(xaxis = list(title = "Year"))
```
...
#ggplotly(Communicable.Female.plot[[1]]) %>% layout(xaxis = list(title = "Year"))
ggplotly(`All other causes.Male.plot`[[3]]) %>% layout(xaxis = list(title = "Year"))
```
...
#ggplotly(Communicable.Female.plot[[1]]) %>% layout(xaxis = list(title = "Year"))
ggplotly(`All other causes.Female.plot`[[3]]) %>% layout(xaxis = list(title = "Year"))
```
