...
males.era3 <- ggplotly(
  ggplot(subset(cod.df.males, era == "1993-2013"), aes(y = state.gdiff.num.1, x = new.start.3)) +
...
**Figure 1a: Decomposition of the change in the female black-white life expectancy gap by cause of death between 1969 and 1983 by US state**
