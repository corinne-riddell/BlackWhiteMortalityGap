...
**All the above together as one figure**

```{r, fig.align="center", fig.height=9, fig.width=15, echo=F, eval = T}
...
**S2 Table: Decomposition of the change in the male black-white life expectancy gap by cause of death between 1969 and 1983 by US state**
...
cod_change_results2 <- cod_change_results2 %>% 
  ...
  rename(Sex = sex, State = state, 
         `Change from 1969 to 1983, years` = total_era1_diff,
         `Change from 1983 to 1993, years` = total_era2_diff,
         `Change from 1993 to 2013, years` = total_era3_diff,
         `Contribution to gap change ('69-'83), years` = contribution_era1_diff,
         `Contribution to gap change ('83-'93), years` = contribution_era2_diff,
         `Contribution to gap change ('93-'03), years` = contribution_era3_diff)

DT::datatable(cod_change_results2 %>% filter(Sex == "Male"))
```

**S3 Table: Decomposition of the change in the female black-white life expectancy gap by cause of death between 1969 and 1983 by US state**

```{r, echo=F}
DT::datatable(cod_change_results2 %>% filter(Sex == "Female"))
```
