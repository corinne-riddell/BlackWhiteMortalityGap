---
title: Exploring how changes in cause of death have narrowed the black-white life expectancy gap in the United States.
...
```{r ny_1969_1983_age_cod_decomp, echo = F, fig.width = 9, eval=F}
...
**Pennsylvania**
```{r pa_1993_1983_age_cod_decomp, echo = F, fig.width = 9, eval=F}
...
**Connecticut**
```{r ct_1993_1983_age_cod_decomp, echo = F, fig.width = 9, eval=F}
...
**Mississippi**
```{r ms_1993_1983_age_cod_decomp, echo = F, fig.width = 9, eval=F}
...
**Florida**
```{r fl_1993_1983_age_cod_decomp, echo = F, fig.width = 9, eval=F}
...
data.table::data.table(cod_change_results2 %>% filter(Sex == "Male"))
```
...
```{r}
data.table::data.table(cod_change_results2 %>% filter(Sex == "Female"))
```
