...
```{r figure1, fig.align = "center", echo=F, fig.height=9}
...
ny.dat <- age_cod_results %>% filter(state == "New York" & year %in% c(1969, 1983) & sex == "Male") %>% 
...
ggplotly(ggplot(rbind(ny.1969, ny.1983),
                aes(y = age, x = start)) + 
